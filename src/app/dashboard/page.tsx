    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginBottom: '32px' }}>
          ...
          <button onClick={() => { window.location.href = '/dashboard/quartus' }} style={{ padding: '14px 28px', backgroundColor: '#0A2E1E', color: '#01D98D', border: 'none', borderRadius: '10px', fontSize: '14px', fontWeight: 700, cursor: 'pointer', fontFamily: 'DM Sans, sans-serif' }}>QUARTUS - MTD Submissions &rarr;</button>
