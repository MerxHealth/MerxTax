    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#fff', color: '#0A2E1E', overflowX: 'hidden' }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Buttons */
        .btn-g { display: inline-block; padding: 16px 32px; background: #01D98D; color: #0A2E1E; font-family: 'Montserrat', sans-serif; font-weight: 800; font-size: 13px; letter-spacing: 0.06em; text-transform: uppercase; border-radius: 10px; text-decoration: none; border: none; cursor: pointer; transition: transform 0.15s, box-shadow 0.15s; }
        .btn-g:hover { transform: translateY(-2px); box-shadow: 0 10px 28px rgba(1,217,141,0.24); }
        .btn-o { display: inline-block; padding: 15px 32px; background: transparent; color: #0A2E1E; font-family: 'Montserrat', sans-serif; font-weight: 700; font-size: 13px; letter-spacing: 0.06em; text-transform: uppercase; border-radius: 10px; text-decoration: none; border: 1.5px solid rgba(10,46,30,0.16); cursor: pointer; transition: border-color 0.15s, color 0.15s, background 0.15s; }
      ...
      {/* ── HERO ── */}
      <section style={{ minHeight: 'calc(100vh - 72px)', display: 'flex', background: 'linear-gradient(180deg, #FFFFFF 0%, #FCFFFE 100%)' }}>
        <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 28px', display: 'flex', alignItems: 'center', width: '100%', gap: 32 }} className="hlayout">

          {/* Left — type */}
          <div style={{ flex: '1 1 480px', padding: '92px 0 88px' }}>
            {/* Live badge — clean, not dominant */}
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 7, marginBottom: 28, padding: '8px 12px', border: '1px solid rgba(10,46,30,0.08)', borderRadius: 999, background: '#FFFFFF' }}>
            ...
            <p style={{ fontSize: 17, fontWeight: 500, color: '#5A6370', lineHeight: 1.75, maxWidth: 500, marginBottom: 40 }}>
          ...
          <div className="hpart" style={{ flex: '0 0 420px', position: 'relative', alignSelf: 'stretch', minHeight: '100%', borderRadius: 28, overflow: 'hidden', background: 'radial-gradient(circle at top left, rgba(1,217,141,0.08), rgba(255,255,255,0.9) 58%)', border: '1px solid rgba(10,46,30,0.06)', boxShadow: '0 28px 60px rgba(10,46,30,0.07)' }}>
            <ParticleCanvas />
          </div>
        </div>
      </section>
