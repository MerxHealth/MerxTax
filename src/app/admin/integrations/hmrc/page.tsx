...
export default function HmrcIntegrationsPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    const sandbox = connections?.find((c: HmrcConnection) => c.environment === 'sandbox' && !c.revoked_at) ?? null;
    const production = connections?.find((c: HmrcConnection) => c.environment === 'production' && !c.revoked_at) ?? null;
